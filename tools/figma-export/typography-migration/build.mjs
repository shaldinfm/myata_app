/*
 * Generates typography-migration/code.js from main.tmpl.js by splicing in the
 * frozen classifier from the trial plugin.
 *
 *   node tools/figma-export/typography-migration/build.mjs [--check]
 *
 * The migration must apply exactly what was approved visually, so the rule block
...
if (process.argv.includes("--check")) {
  ...
  if (current !== generated) {
    console.error("code.js is stale - re-run: node tools/figma-export/typography-migration/build.mjs");
    process.exit(1);
  }
